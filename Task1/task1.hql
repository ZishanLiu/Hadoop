...
use database '${hivevar:databaseName}'
CREATE TABLE IF NOT EXISTS '${hivevar:tableName}'(year int,temperature float,quality int) ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t' STORED AS TEXTFILE
