...
insert into table RoseStaticEmployeesORC partition(dept='admin') select RoseEmployees.firstName, RoseEmployees.lastName, RoseEmployees.pos, RoseEmployees.eid from RoseEmployees where dept='admin';
insert into table RoseStaticEmployeesORC partition(dept='csse') select RoseEmployees.firstName, RoseEmployees.lastName, RoseEmployees.pos, RoseEmployees.eid from RoseEmployees where dept='csse';
insert into table RoseStaticEmployeesORC partition(dept='ece') select RoseEmployees.firstName, RoseEmployees.lastName, RoseEmployees.pos, RoseEmployees.eid from RoseEmployees where dept='ece';
